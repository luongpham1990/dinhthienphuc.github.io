...
<!-- Main Content -->
<div class="container">
<!--    <form id="search" method="get" action="view" style="text-align: center;">-->
<!--        <input name="s" type="text" novalidate placeholder="Search here..." style="border-radius: 10px; width: 400px; height: 50px; padding-left: 20px">-->
<!--        <button type="submit" id="butt"><li class="fa fa-search" style="color: white;"></li></button>-->
<!--    </form>-->
